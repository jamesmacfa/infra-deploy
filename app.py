...
users = {
    "developer": "phrase_user",  # Define valid username and password
}

#Basic auth at app level rather than LB
...
@app.route('/admin')
@auth.login_required  # Protect the /admin endpoint with Basic Auth
def admin():
    if not is_ready():
        return 'Not ready', 404
    return 'admin area'
